...
const MobileInfoPage = () => {
    const requiredDocuments = [
        ...
        { 
          icon: '🥘', 
          name: 'Menu (Optional)', 
          description: 'If details of food items purchased are not listed on the original copy of receipt, a menu from the restaurant is required', 
        },
    ]
    ...
    return (
      ...
      >
          <h1 className="text-5xl font-bold pt-5">Meals Purchases</h1>
